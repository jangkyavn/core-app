! function (e, n, a) {
    ...
    a.app.menu = {
                ...
                if (this.obj) {
                    if (!0 === a(".main-menu").data("scroll-to-active")) {
                        ...
                        e = a(".main-menu-content").find("li.active").parents("li").length > 0 ? a(".main-menu-content").find("li.active").parents("li").last().position() : a(".main-menu-content").find("li.active").position(), setTimeout(function () {
                            void 0 !== e && a.app.menu.container.stop().animate({
                                scrollTop: e.top
        ...
        changeMenu: function (e) {
            ...
            "sm" == e || "xs" == e ? (i.removeClass(i.data("menu")).addClass("vertical-layout vertical-overlay-menu fixed-navbar"), a("nav.header-navbar").addClass("fixed-top"), n.removeClass().addClass("main-menu menu-light menu-fixed menu-shadow"), t.removeClass().addClass("navigation navigation-main"), l.removeClass("dropdown mega-dropdown").addClass("has-sub"), l.children("ul").removeClass(), r.each(function (e, n) {
                a(n).find(".mega-menu-sub").find("li").has("ul").addClass("has-sub");
                var i = a(n).children().first(),
                    t = "";
                i.is("h6") && (t = i.html(), i.remove(), a(n).prepend('<a href="#">' + t + "</a>").addClass("has-sub mega-menu-title"))
            ...
            })) : (i.removeClass("vertical-layout vertical-overlay-menu fixed-navbar").addClass(i.data("menu")), a("nav.header-navbar").removeClass("fixed-top"), n.removeClass().addClass(o), this.drillDownMenu(e), a("a.dropdown-item.nav-has-children").on("click", function () {
        ...
        bind_events: function () {
            ...
            a(".navigation-main").on("mouseenter.app.menu", "li", function () {
                ...
                var i = a(this);
                if (i.is(".disabled")) n.preventDefault();
                else if (i.has("ul"))
                    if (i.is(".open")) i.removeClass("open"), e.collapse(i);
                    else {
                        if (i.addClass("open"), e.expand(i), a(".main-menu").hasClass("menu-collapsible")) return !1;
                        i.siblings(".open").find("li.open").trigger("close.app.menu"), i.siblings(".open").trigger("close.app.menu"), n.stopPropagation()
        ...
        adjustSubmenu: function (e) {
            var n, i, s, o, l, r, d = e.children("ul:first"),
                m = d.clone(!0);
        ...
        expand: function (e, n) {
            var i = e.children("ul"),
                t = i.children("li").addClass("is-hidden");
