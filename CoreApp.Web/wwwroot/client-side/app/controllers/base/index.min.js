"use strict";var BaseController={initialize:function(){BaseController.loadHeaderCart();BaseController.initialControls();BaseController.registerEvents()},registerEvents:function(){$("body").on("click",".remove-cart",function(n){n.preventDefault();var t=parseInt($(this).data("id"));core.callAjax("/Cart/RemoveFromCart","POST",{productId:t},"json",function(){core.notify(resources.delete_to_item_cart_success,"success");BaseController.loadHeaderCart()})});$("body").on("click",".btn-country",function(n){n.preventDefault();var t=$(this).data("value");$("#hidCulture").val(t);$("#selectLanguage").submit()});$(".btn-quich-view").on("click",function(n){n.preventDefault();var t=$(this).data("id");$("#btnQuickViewAddToCart").attr("data-id",t);$("#quickViewModal").modal("show");BaseController.loadQuickViewData(t)});$("#btnQuickViewAddToCart").on("click",function(n){n.preventDefault();var t=parseInt($(this).data("id")),i=parseInt($("#ddlQuickViewColors").val()),r=parseInt($("#ddlQuickViewSizes").val());core.callAjax("/Cart/AddToCart","POST",{productId:t,quantity:parseInt($("#txtQuickViewQuantity").val()),color:i,size:r},"json",function(){core.notify(resources.add_to_cart_success,"success");BaseController.loadHeaderCart()})});$("body").on("click",".btn-compare",function(n){n.preventDefault();var t=$(this).data("id");core.callAjax("/Compare/AddToCompare","POST",{productId:t},"json",function(n){n?core.notify(resources.add_success,"success"):core.notify(resources.require_login,"warning")})})},initialControls:function(){$("#txtKeywordSearch").autocomplete({minLength:0,source:function(n,t){$.ajax({url:"/Product/SuggestSearchResult",type:"get",dataType:"json",data:{keyword:n.term},success:function(n){t(n)}})},select:function(n,t){return $("#txtKeywordSearch").val(t.item.Name),!1},open:function(){$(".ui-autocomplete").css("width","550px");$(".ui-autocomplete").css("max-height","500px");$(".ui-autocomplete").css("overflow-y","auto")}}).autocomplete("instance")._renderItem=function(n,t){return $("<li>").append(`
