"use strict";var BaseController={initialize:function(){BaseController.loadHeaderCart();BaseController.initialControls();BaseController.registerEvents()},registerEvents:function(){$("body").on("click",".remove-cart",function(n){n.preventDefault();var t=parseInt($(this).data("id"));core.callAjax("/Cart/RemoveFromCart","POST",{productId:t},"json",function(){core.notify(resources.delete_to_item_cart_success,"success");BaseController.loadHeaderCart()})});$("body").on("click",".btn-country",function(n){n.preventDefault();var t=$(this).data("value");$("#hidCulture").val(t);$("#selectLanguage").submit()});$("body").on("click",".btn-compare",function(n){n.preventDefault();var t=$(this).data("id");core.callAjax("/Compare/AddToCompare","POST",{productId:t},"json",function(n){n&&core.notify(resources.add_success,"success")})})},initialControls:function(){$("#txtKeywordSearch").autocomplete({minLength:0,source:function(n,t){$.ajax({url:"/Product/SuggestSearchResult",type:"get",dataType:"json",data:{keyword:n.term},success:function(n){t(n)}})},select:function(n,t){return $("#txtKeywordSearch").val(t.item.Name),!1},open:function(){$(".ui-autocomplete").css("width","550px");$(".ui-autocomplete").css("max-height","500px");$(".ui-autocomplete").css("overflow-y","auto")}}).autocomplete("instance")._renderItem=function(n,t){return $("<li>").append(`
