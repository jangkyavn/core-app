        ...
        public async Task Seed()
        {
            ...
            if (!_context.ContactDetails.Any())
            {
                _context.ContactDetails.Add(new ContactDetail()
                {
                    ...
                    Email = "ct1801.hpu@gmail.com",
                    Name = "Shop Mart",
                    Phone = "0936613439",
                    Status = Status.Active,
                    Website = "http://shopmart.com",
                    Lat = "20.8385693",
                    Lng = "106.6876014"
                });
            }
            if (_context.Functions.Count() == 0)
            {
                _context.Functions.AddRange(new List<Function>()
                {
                    ...
                    new Function() {Id = "COLOR",Name = "Color",ParentId = "PRODUCT",SortOrder = 4,Status = Status.Active,URL = "/admin/color/index",IconCss = "fa-chevron-down"  },
                    new Function() {Id = "SIZE",Name = "Size",ParentId = "PRODUCT",SortOrder = 5,Status = Status.Active,URL = "/admin/size/index",IconCss = "fa-chevron-down"  },
